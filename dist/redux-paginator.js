...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.isCurrentPageFetching = exports.getCurrentTotalResultsCount = exports.getAllResults = exports.getCurrentPageResults = exports.getCurrentPageNumber = exports.requestPageWatcher = exports.createPaginatorMiddleware = exports.createPaginator = undefined;
	...
	exports.createPaginatorMiddleware = _paginatorMiddleware2["default"];
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var requestPage = exports.requestPage = function requestPage(endpoint, name, initialItem, resultsKey, countKey, pageArgName, idKey, page, params) {
	  return {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var fetchPage = exports.fetchPage = function fetchPage(endpoint, pageArgName, page, params, useCache) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var requestPageActionCreatorForEndpoint = exports.requestPageActionCreatorForEndpoint = function requestPageActionCreatorForEndpoint(endpoint, name, pageArgName, idKey, initialItem, resultsKey, countKey) {
	  return function (page, params) {
	    return (0, _actions.requestPage)(endpoint, name, initialItem, resultsKey, countKey, pageArgName, idKey, page, params);
	  };
	};

	var getRequestPageActionCreatorsFor = exports.getRequestPageActionCreatorsFor = function getRequestPageActionCreatorsFor(endpoint, names, pageArgName, idKey, initialItem, resultsKey, countKey) {
	  var actions = {};
	  for (var _iterator = names, _isArray = Array.isArray(_iterator), _i = 0, _iterator = _isArray ? _iterator : _iterator[Symbol.iterator]();;) {
	    ...
	    actions = _extends({}, actions, (_extends2 = {}, _extends2[name] = {
	      requestPage: requestPageActionCreatorForEndpoint(endpoint, name, pageArgName, idKey, initialItem, resultsKey, countKey)
	    }, _extends2));
	  }
	  return actions;
	};
	...
	var createPaginator = exports.createPaginator = function createPaginator(endpoint, names, _ref2) {
	  ...
	  var requestPageActionCreators = getRequestPageActionCreatorsFor(endpoint, names, pageArgName, idKey, initialItem, resultsKey, countKey);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _marked = /*#__PURE__*/regeneratorRuntime.mark(fetchPage),
	    _marked2 = /*#__PURE__*/regeneratorRuntime.mark(requestPageWatcher);

	function fetchPage(endpoint, name, initialItem, resultsKey, countKey, pageArgName, idKey, page, params) {
	    ...
	    while (1) {
	      switch (_context.prev = _context.next) {
	        case 0:
	          ...
	          _context.next = 4;
	          return (0, _effects.call)(_agent.fetchPage, endpoint, pageArgName, page, params);
	...
	function requestPageWatcher() {
	  var _ref2, _ref2$meta, endpoint, name, initialItem, resultsKey, countKey, pageArgName, idKey, _ref2$payload, page, params;
	    ...
	    while (1) {
	      switch (_context2.prev = _context2.next) {
	        ...
	        case 3:
	          ...
	          _context2.next = 17;
	          return (0, _effects.fork)(fetchPage, endpoint, name, initialItem, resultsKey, countKey, pageArgName, idKey, page, params);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */}.call(exports, (function() { return this; }()) || Function('return this')(), __webpack_require__(41)(module)))
